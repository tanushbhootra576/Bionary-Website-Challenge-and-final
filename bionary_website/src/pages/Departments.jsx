  ...
  const departments = [
    {
      ...
      image: "",
      type: "Technical",
      description: "Designing responsive, robust and efficient websites.",
      lead: {
        name: "Web Lead",
        image: "",
      },
    ...
    },
    {
      ...
      subleads: [
        {
          name: "Robotics Sublead1",
          id: 1,
          image: "",
        },
        {
          name: "Robotics Sublead2",
          id: 2,
          image: "",
        },
      ],
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-row gap-8 text-center">
                    <div className="flex flex-col gap-2">
                      <h3 className="gradient-text bold">Lead</h3>
                      <h4 className="bold">{department.lead.name}</h4>
                      <img
                    ...
                    <div className="flex flex-col gap-2">
                      <h3 className="gradient-text bold">Sublead</h3>
                      <h4 className="bold">{department.subleads[0].name}</h4>
                      <img
                        src={department.subleads[0].image}
                        alt={department.subleads[0].name}
                        width={"60px"}
                        height={"60px"}
                      />
                    </div>
                    <div className="flex flex-col gap-2">
                      <h3 className="gradient-text bold">Sublead</h3>
                      <h4 className="bold">{department.subleads[1].name}</h4>
                      <img
                        src={department.subleads[1].image}
                        alt={department.subleads[1].name}
                        width={"60px"}
                        height={"60px"}
                      />
                    </div>
